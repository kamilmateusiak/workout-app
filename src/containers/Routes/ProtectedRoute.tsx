...
const ProtectedRouteContainer: React.FC<IProps> = ({ component: Component, isAuthenticated, ...restProps }) => {
  return (
...
export const ProtectedRoute = withAuth(ProtectedRouteContainer)